...
var grammar = {
    ...
    {"name": "prod$plus$1$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "prod$plus$1$subexpression$1", "symbols": [{"literal":"="}]},
    {"name": "prod$plus$1", "symbols": ["prod$plus$1$subexpression$1"]},
    {"name": "prod$plus$1", "symbols": ["prod$plus$1$subexpression$1", "prod$plus$1"], "postprocess": function arrconcat(d) {
        return [d[0]].concat(d[1]);
    }},
    {"name": "prod", "symbols": ["word", "whit?", "prod$plus$1", {"literal":">"}, "whit?", "expression+"], "postprocess": function(d) { return {name: d[0], rules: d[5]}; }},
